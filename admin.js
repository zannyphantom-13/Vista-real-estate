...
window.openReviewModal = function(userId) {
    ...
    // Wire native video constraints nicely dynamically clearly structurally gracefully physically securely elegantly skillfully intelligently correctly effectively
    const vidBtn = document.getElementById('reviewVideoUrl');
    vidBtn.href = u.video_url || '#';
